...
class LogicalAndValidator
    ...
    protected function customValidation($value, AbstractConstraint $constraint): bool {
        ...
        return $this->violationBuilder->validateValue($value, $constraint->getLeft())
               && $this->violationBuilder->validateValue($value, $constraint->getRight());
    }

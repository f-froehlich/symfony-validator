...
use FabianFroehlich\Validator\Constraints\IsGreaterThanOrEqual;
...
/**
 * Class IsGreaterThanOrEqualValidatorTest
 *
...
class IsGreaterThanOrEqualValidatorTest
     ...
     * @test
     */
    public function notAcceptIntLower(): void {
        ...
        $this->assertEquals(ErrorCodes::NOT_GREATER_OR_EQUAL_ERROR()->value(), $violations[0]->getCode());
    ...
    protected function getConstraintClass(): string {
        ...
        return IsGreaterThanOrEqual::class;
    }

    /**
     * @test
     */
    public function notAcceptFloatLower(): void {
     ...
     * @test
     */
    public function acceptIntEqual(): void {
     ...
     * @test
     */
    public function acceptFloatEqual(): void {
     ...
     * @test
     */
    public function acceptGreaterFloat(): void {
     ...
     * @test
     */
    public function acceptGreaterInt(): void {

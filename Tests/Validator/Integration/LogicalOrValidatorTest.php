...
class LogicalOrValidatorTest
    ...
    public function checkBothValuesPassed(): void {
        $constraint = new LogicalOr(['left' => new IsNull(), 'right' => new IsNull()]);
    ...
    public function passIfLeftValueIsValid(): void {
        $constraint = new LogicalOr(['left' => new IsNull(), 'right' => new IsNotNull()]);
    ...
    public function passIfRightValueIsPassed(): void {
        $constraint = new LogicalOr(['left' => new IsNotNull(), 'right' => new IsNull()]);
    ...
    public function failIfBothValueIsInvalid(): void {
        $constraint = new LogicalOr(['left' => new IsNotNull(), 'right' => new IsNotNull()]);

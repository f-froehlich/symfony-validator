...
/**
 * Class IsGreaterThanValidatorTest
 *
...
class IsGreaterThanValidatorTest
    ...
    public function notAcceptIntZero(): void {
        ...
        $this->assertEquals(ErrorCodes::NOT_GREATER_ERROR()->value(), $violations[0]->getCode());
     ...
     * @test
     */
    public function acceptPosotiveFloat(): void {
     ...
     * @test
     */
    public function acceptPositiveInt(): void {

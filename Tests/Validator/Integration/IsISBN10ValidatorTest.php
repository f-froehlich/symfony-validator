...
use FabianFroehlich\Validator\Constraints\IsISBN10;
use FabianFroehlich\Validator\Tests\AbstractISBNValidatorTestCase;

/**
 * Class IsISBN10ValidatorTest
 *
...
class IsISBN10ValidatorTest
     ...
     * @test
     */
    public function checkInvalidLength10(): void {
        $this->checkLength($this->getInvalidIsbn10Length());
    }

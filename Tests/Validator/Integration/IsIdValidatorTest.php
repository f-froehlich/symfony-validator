...
class IsIdValidatorTest
     ...
     * @test
     */
    public function notAcceptIntLowerOne(): void {
        ...
        $this->assertEquals(ErrorCodes::NOT_ID_ERROR()->value(), $violations[0]->getCode());
     ...
     * @test
     */
    public function acceptIntUpperOrEqualOne(): void {
    ...
    protected function getRequiredType(): string {
        return AbstractConstraintValidator::INT;
    }
    ...
    protected function getValidTypes(): array {
        ...
        return [self::INT, self::INT_POSITIVE, self::INT_ZERO, self::INT_NEGATIVE, self::NUMBER_OR_STRING_INT];
    }

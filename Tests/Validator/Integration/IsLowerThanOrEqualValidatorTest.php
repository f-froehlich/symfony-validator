...
/**
 * Class IsLowerThanOrEqualValidatorTest
 *
...
class IsLowerThanOrEqualValidatorTest
     ...
     * @test
     */
    public function notAcceptIntGreater(): void {
        ...
        $this->assertEquals(ErrorCodes::NOT_LOWER_OR_EQUAL_ERROR()->value(), $violations[0]->getCode());
     ...
     * @test
     */
    public function notAcceptFloatGreater(): void {

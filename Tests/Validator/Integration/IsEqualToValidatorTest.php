...
class IsEqualToValidatorTest
     ...
     * @test
     */
    public function willNotSucceedIfValuesNotEquals(): void {
        ...
        $this->assertEquals('other', $violations[0]->getInvalidValue());
        $this->assertEmpty($violations[0]->getPropertyPath());
        $this->assertEquals(ErrorCodes::NOT_EQUAL_ERROR()->value(), $violations[0]->getCode());

...
use FabianFroehlich\Validator\Constraints\IsNumber;
use FabianFroehlich\Validator\Tests\ConstraintTestCase;
use FabianFroehlich\Validator\Validator\IsNumberValidator;
...
class IsNumberTest
    ...
    protected function getRequiredValidatorClass(): string {
        ...
        return IsNumberValidator::class;
    }
